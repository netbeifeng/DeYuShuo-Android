...
public class LifeRecyAdapter extends RecyclerView.Adapter<LifeRecyAdapter.ViewHolder> {
    private Context context;
    private List<ListItem> list;
    private OnItemClickListener mOnItemClickListener;
    public LifeRecyAdapter(Context context,List<ListItem> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.life_card_view_list,parent,false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            iv_backgroud = (ImageView) itemView.findViewById(R.id.card_view_life);
